...
:exclamation: You must delete SoCompiler’s storage file located at `/data/SoCompiler.json` before running it! Not doing
so will cause AddressBook to default to an empty address book!
